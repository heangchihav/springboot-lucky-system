package com.example.callservice.api.userbranch;
...
public class UserBranchController {
    ...
    public ResponseEntity<List<UserBranchResponse>> getUserBranchesByUser(@PathVariable Long userId) {
        ...
        List<UserBranchResponse> response = userBranches.stream()
                .map(ub -> new UserBranchResponse(
                        ...
                        ub.getBranch().getArea() != null ? ub.getBranch().getArea().getId() : null,
                        ub.getBranch().getArea() != null ? ub.getBranch().getArea().getName() : null,
                        ub.getActive(),
                        ub.getAssignedAt(),
                        ub.getUpdatedAt()))
    ...
    @PostMapping("/assign")
    public ResponseEntity<UserBranchResponse> assignUserToBranch(@RequestBody AssignUserRequest request,
        ...
        try {
            ...
            UserBranchResponse response = new UserBranchResponse(
                    ...
                    userBranch.getBranch().getArea() != null ? userBranch.getBranch().getArea().getId() : null,
                    userBranch.getBranch().getArea() != null ? userBranch.getBranch().getArea().getName() : null,
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UserBranchResponse> updateUserBranch(@PathVariable Long id,
            @RequestBody UserBranch userBranch) {
        try {
            ...
            UserBranchResponse response = new UserBranchResponse(
                    ...
                    updatedUserBranch.getBranch().getArea() != null ? updatedUserBranch.getBranch().getArea().getId()
                            : null,
                    updatedUserBranch.getBranch().getArea() != null ? updatedUserBranch.getBranch().getArea().getName()
                            : null,
