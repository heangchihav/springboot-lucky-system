...
@Entity
@Table(name = "marketing_service_roles")
public class Role {
    ...
    @JoinTable(name = "marketing_service_role_permissions", joinColumns = @JoinColumn(name = "role_id"), inverseJoinColumns = @JoinColumn(name = "permission_id"))
