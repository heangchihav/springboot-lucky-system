package com.example.callservice.entity.branch;
...
@Entity
@Table(name = "branches")
@JsonIgnoreProperties({ "area", "subarea", "userBranches" })
public class Branch {
    ...
    @NotNull(message = "Subarea is required")
    @ManyToOne(fetch = FetchType.LAZY)
    ...
    public Branch(String name, String description, String code, Area area, Subarea subarea) {
        this.name = name;
    ...
    public String toString() {
        return "Branch{" +
                ...
                ", subarea=" + (subarea != null ? subarea.getName() : "null") +
                ", active=" + active +
                '}';
    }
}
