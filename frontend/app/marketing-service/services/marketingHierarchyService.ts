...
export const marketingHierarchyService = {
  ...
  updateSubArea(id: number, payload: SubAreaPayload): Promise<MarketingSubArea> {
  ...
  listBranches(params?: { areaId?: number; subAreaId?: number }): Promise<MarketingBranch[]> {
    const urlParams = new URLSearchParams()
    if (params?.areaId) urlParams.append('areaId', String(params.areaId))
    if (params?.subAreaId) urlParams.append('subAreaId', String(params.subAreaId))
