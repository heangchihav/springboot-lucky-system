...
export default function ManageUserPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const userData: CreateUserRequest = {
        ...
        serviceIds: formData.serviceIds.length > 0 ? formData.serviceIds.map(id => parseInt(id)) : undefined
      }
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-semibold text-white">User Service · Manage Users</h2>
      ...
      {editingUser && (
        <div className="bg-slate-800 rounded-lg p-6 border border-slate-700">
          <h3 className="text-lg font-medium text-white mb-4">Edit User: {editingUser.fullName}</h3>
