...
import {
  ...
  usePermission,
  useMenuPermissions,
} from "@/components/layout/PermissionGuard";
  ...
  return (
    <div className="p-4">
      ...
      <PermissionGuard
        ...
        fallback={<span className="text-gray-400">No create access</span>}
      >
      ...
      fallback={
        <div className="bg-yellow-100 p-4 border border-yellow-300 rounded">
          <p className="text-yellow-700">
            Admin access required. You don't have permission to manage users.
          </p>
        </div>
      }
    >
