...
export function MarketingServiceGuard({
  children,
  fallback = null,
}: MarketingServiceGuardProps) {
        ...
        <div className="flex min-h-[50vh] items-center justify-center rounded-3xl border border-white/10 bg-red-500/5 p-10 text-center text-slate-200">
          <div>
            ...
            <p className="mt-3 text-sm text-slate-300">
              You need marketing-service access to view this
              dashboard.&nbsp;Contact an administrator if you believe this is a
              mistake.
            </p>
          </div>
        </div>
